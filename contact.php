<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $secretKey = "6LcpHa4kAAAAAKYYMRmYc-xQ5dd5iQq8QZ0I1RSj";
        ...
        if($response->success){
            if(mail($to, $subject, $msgBody, $headers)){
                ...
                $msg = "Failed to sent the message!";
            }
        }
        else{
                    ...
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        ...
                        <div class="my-5">
                            <form action="server/contact.php" method="POST">
                                ...
                                <div class="form-floating">
                                    <div class="g-recaptcha" data-sitekey="6LcpHa4kAAAAAHT2WXDJgm679lsDzBm7iXJ-bsBg"></div>
                                </div>
